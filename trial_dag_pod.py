...
with dag:
    ...
    third_task = BashOperator(
        ...
        bash_command = 'ssh -p 29418 -i "/home/airflow/.ssh/id_rsa" -o "StrictHostKeyChecking=no" -p 29418 "vishrut@qa-source-secure.haleytek.net" gerrit review --code-review +2 2,2',
        dag = dag,
