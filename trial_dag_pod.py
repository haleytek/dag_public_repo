...
with dag:
    ...
    third_task = BashOperator(
        ...
        bash_command = 'echo "PRINTING USER BELOW" && whoami && echo "$HOSTNAME" && ls -all /home/airflow/ && echo "PRINTING THIS BEFORE STARTING THE SSH RUN" && set -x && ssh -p 29418 -i "/home/airflow/.ssh/id_rsa" -o "StrictHostKeyChecking=no" -p 29418 "vishrut@qa-source-secure.haleytek.net" gerrit review --code-review +1 2,1 -vv',
        dag = dag,
