...
with dag:
    ...
    third_task = BashOperator(
        ...
        bash_command = 'export GIT_SSH_COMMAND="ssh -i /opt/bitnami/.ssh/id_rsa" && git clone @github.com:haleytek/dag_public_repo.git /opt/bitnami/airflow/auysfv && echo THIS_ACTUALLY_WORKS',
