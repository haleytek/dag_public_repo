...
with dag:
    ...
    third_task = BashOperator(
        ...
        bash_command = 'ssh -i "/opt/bitnami/airflow/id_rsa" -o "StrictHostKeyChecking=no" -p 29418 "vishrut@qa-source-secure.haleytek.net" gerrit review --code-review +1 1,2',
        dag = dag,
